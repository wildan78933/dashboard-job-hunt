...
import DialogAddTeam from "./DialogAddFormTeam";
      ...
      <div className="w-[65%] mb-5">
        ...
        <div className="grid grid-cols-3 gap-5 mt-6 ">
          {[0, 1, 2].map((item: number) => (
            <div key={item} className="p-3 shadow">
              <div className="w-14 h-14 rounded-full mx-auto bg-gray-300" />
              <div className="mt-4 font-semibold">Wildan</div>
